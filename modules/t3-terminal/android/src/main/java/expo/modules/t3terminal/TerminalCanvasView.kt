  ...
  private inner class TerminalGestureListener : GestureDetector.SimpleOnGestureListener() {
    ...
    override fun onSingleTapUp(event: MotionEvent): Boolean {
      if (selectionActive) {
        ...
        // Focus only after GestureDetector proves this was a tap. Requesting
        // focus in onDown also fires for scroll/fling gestures, which opens the
        // software keyboard while the user is only browsing terminal history.
